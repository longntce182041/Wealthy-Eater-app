...
class IngredientDTO(BaseModel):
    ...
    calories: float = Field(..., gt=0, description="Calories ")
    protein: float = Field(..., ge=0, description="Protein grams")
    carbs: float = Field(..., ge=0, description="Carbs grams")
    fat: float = Field(..., ge=0, description="Fat grams")
